...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #2196F3, #0b79d0); padding: 20px; text-align: center;">
    <h1 style="color: white; margin: 0;">Welcome to Our BlogSite!</h1>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello {username},</p>
    ...
    <ul>
      <li>Complete your profile to let us know more about you.</li>
      <li>Explore our features and find out how we can help you.</li>
